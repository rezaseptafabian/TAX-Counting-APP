...
public class CurrentLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void ambilLastLocation() {

        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]
                    {Manifest.permission.ACCESS_FINE_LOCATION},REQUST_CODE);
            return;
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions markerOptions = new MarkerOptions().position(latLng).title("Saya di sini.");
